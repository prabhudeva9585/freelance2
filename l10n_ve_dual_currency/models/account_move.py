...
class AccountMove(models.Model):
	...
	global_rate_ref = fields.Boolean(string='Tasa global', default=True, readonly=True, 
                                #   states={'draft': [('readonly', False)]}
                                  )
	currency_rate_ref = fields.Many2one('res.currency.rate', string='Tasa de cambio', tracking=True, default=lambda self: self.env.company.currency_ref_id.get_currency_rate(), readonly=True, 
                                    #  states={'draft': [('readonly', False)]}, 
