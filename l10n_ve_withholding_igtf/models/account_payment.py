...
class AccountPayment(models.Model):
	...
	calculate_igtf = fields.Boolean(string='Permitir IGTF', default=True, readonly=True, 
                                #  states={'draft': [('readonly', False)]}
                                 )
	igtf_journal_id = fields.Many2one('account.journal', string='Diario IGTF', readonly=True, 
                                #    states={'draft': [('readonly', False)]}, 
